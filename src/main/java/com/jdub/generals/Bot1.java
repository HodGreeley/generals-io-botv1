...
public class Bot1 implements Bot {
    ...
    private Map<Integer, Position> generals = new HashMap<Integer, Position>();

    public Bot1(Actions actions) {
    ...
    private void advanceArmiesTowardsEnemy(GameState newGameState) {
        ...
        *** Larget army finder excludes general until it is 20% of the total armies ??? not sure if that is sound
